...
func TestShardKeyUint64InitialState(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(5, 5)
	l, sz, c := cache.Stats()
	if l != 0 {
...
func TestShardKeyUint64SetInsertsValue(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	data := &CacheValue{0}
...
func TestShardKeyUint64SetIfAbsent(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	data := &CacheValue{0}
	var k key.KeyUint64 = 1
...
func TestShardKeyUint64GetValueWithMultipleTypes(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	data := &CacheValue{0}
	var k key.KeyUint64 = 1
	cache.Set(k, data)
...
func TestShardKeyUint64SetUpdatesSize(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
...
func TestShardKeyUint64SetWithOldKeyUpdatesValue(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	emptyValue := &CacheValue{0}
	k := key.KeyUint64(1)
	cache.Set(k, emptyValue)
...
func TestShardKeyUint64SetWithOldKeyUpdatesSize(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	emptyValue := &CacheValue{0}
	k := key.KeyUint64(1)
	cache.Set(k, emptyValue)
...
func TestShardKeyUint64GetNonExistent(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
...
func TestShardKeyUint64Delete(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	value := &CacheValue{1}
	var k key.KeyUint64 = 1
...
func TestShardKeyUint64Clear(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	value := &CacheValue{1}
	var k key.KeyUint64 = 1
...
func TestShardKeyUint64CapacityIsObeyed(t *testing.T) {
	size := int64(3)
	cache := NewShardLRUCacheKeyUint64(2, 100)
...
func TestShardKeyUint64LRUIsEvicted(t *testing.T) {
	size := int64(3)
	cache := NewShardLRUCacheKeyUint64(1, size)
...
type PurgeCacheValueKeyUint64Shard struct {
}

func (cv *PurgeCacheValueKeyUint64Shard) OnPurge(why PurgeReason) {
	purgeReasonFlag4TestShardKeyUint64 = why
}

var purgeReasonFlag4TestShardKeyUint64 PurgeReason

func TestShardKeyUint64DeleteOnPurge(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	value := &PurgeCacheValueKeyUint64Shard{}
	purgeReasonFlag4TestShardKeyUint64 = PURGE_REASON_CACHEFULL // init
	var k key.KeyUint64 = 1

	cache.Set(k, value)
	cache.Delete(k)
	if purgeReasonFlag4TestShardKeyUint64 != PURGE_REASON_DELETE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_DELETE, purgeReasonFlag4TestShardKeyUint64)
	}

}

func TestShardKeyUint64UpdateOnPurge(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(2, 100)
	value := &PurgeCacheValueKeyUint64Shard{}
	purgeReasonFlag4TestShardKeyUint64 = PURGE_REASON_CACHEFULL // init
	var k key.KeyUint64 = 1
	...
	if purgeReasonFlag4TestShardKeyUint64 != PURGE_REASON_UPDATE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_UPDATE, purgeReasonFlag4TestShardKeyUint64)
	}

}

func TestShardKeyUint64CacheFullOnPurge(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(1, 1)
	value := &PurgeCacheValueKeyUint64Shard{}
	k1 := key.KeyUint64(1)
	k2 := key.KeyUint64(2)

	cache.Set(k1, value)                                     // after this cache is full
	purgeReasonFlag4TestShardKeyUint64 = PURGE_REASON_DELETE // init
	cache.Set(k2, value)                                     // after this k1 is delete and reason set to  PURGE_REASON_CACHEFULL
	if purgeReasonFlag4TestShardKeyUint64 != PURGE_REASON_CACHEFULL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CACHEFULL, purgeReasonFlag4TestShardKeyUint64)
	}

}

func TestShardKeyUint64ClearOnPurge(t *testing.T) {
	cache := NewShardLRUCacheKeyUint64(1, 1)
	value := &PurgeCacheValueKeyUint64Shard{}
	k1 := key.KeyUint64(1)
	purgeReasonFlag4TestShardKeyUint64 = PURGE_REASON_DELETE // init
	cache.Set(k1, value)                                     // after this cache is full
	cache.Clear()
	if purgeReasonFlag4TestShardKeyUint64 != PURGE_REASON_CLEAR_ALL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CLEAR_ALL, purgeReasonFlag4TestShardKeyUint64)
	}

}

func TestShardKeyUint64OnMiss(t *testing.T) {
