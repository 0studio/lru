...
func TestUint32InitialState(t *testing.T) {
	cache := NewLRUCacheUint32(5)
	l, sz, c := cache.Stats()
	if l != 0 {
...
func TestUint32SetInsertsValue(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	data := &CacheValue{0}
	var k uint32 = 1
	cache.Set(k, data)
...
func TestUint32SetIfAbsent(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	data := &CacheValue{0}
	var k uint32 = 1
...
func TestUint32GetValueWithMultipleTypes(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	data := &CacheValue{0}
	var k uint32 = 1
	cache.Set(k, data)
...
func TestUint32SetUpdatesSize(t *testing.T) {
	cache := NewLRUCacheUint32(100)
...
func TestUint32SetWithOldKeyUpdatesValue(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	emptyValue := &CacheValue{0}
	k := uint32(1)
	cache.Set(k, emptyValue)
...
func TestUint32SetWithOldKeyUpdatesSize(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	emptyValue := &CacheValue{0}
	k := uint32(1)
	cache.Set(k, emptyValue)
...
func TestUint32GetNonExistent(t *testing.T) {
	cache := NewLRUCacheUint32(100)
...
func TestUint32CapacityIsObeyed(t *testing.T) {
	size := int64(3)
	cache := NewLRUCacheUint32(100)
...
func TestUint32LRUIsEvicted(t *testing.T) {
	size := int64(3)
	cache := NewLRUCacheUint32(size)
...
type PurgeCacheValueUint32 struct {
}

func (cv *PurgeCacheValueUint32) OnPurge(why PurgeReason) {
	purgeReasonFlag4TestUint32 = why
}

var purgeReasonFlag4TestUint32 PurgeReason

func TestUint32DeleteOnPurge(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	value := &PurgeCacheValueUint32{}
	purgeReasonFlag4TestUint32 = PURGE_REASON_CACHEFULL // init
	var k uint32 = 1

	cache.Set(k, value)
	cache.Delete(k)
	if purgeReasonFlag4TestUint32 != PURGE_REASON_DELETE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_DELETE, purgeReasonFlag4TestUint32)
	}

}

func TestUint32UpdateOnPurge(t *testing.T) {
	cache := NewLRUCacheUint32(100)
	value := &PurgeCacheValueUint32{}
	purgeReasonFlag4TestUint32 = PURGE_REASON_CACHEFULL // init
	var k uint32 = 1
	...
	if purgeReasonFlag4TestUint32 != PURGE_REASON_UPDATE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_UPDATE, purgeReasonFlag4TestUint32)
	}

}

func TestUint32CacheFullOnPurge(t *testing.T) {
	cache := NewLRUCacheUint32(1)
	value := &PurgeCacheValueUint32{}
	k1 := uint32(1)
	k2 := uint32(2)

	cache.Set(k1, value)                             // after this cache is full
	purgeReasonFlag4TestUint32 = PURGE_REASON_DELETE // init
	cache.Set(k2, value)                             // after this k1 is delete and reason set to  PURGE_REASON_CACHEFULL
	if purgeReasonFlag4TestUint32 != PURGE_REASON_CACHEFULL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CACHEFULL, purgeReasonFlag4TestUint32)
	}

}

func TestUint32ClearOnPurge(t *testing.T) {
	cache := NewLRUCacheUint32(1)
	value := &PurgeCacheValueUint32{}
	k1 := uint32(1)
	purgeReasonFlag4TestUint32 = PURGE_REASON_DELETE // init
	cache.Set(k1, value)                             // after this cache is full
	cache.Clear()
	if purgeReasonFlag4TestUint32 != PURGE_REASON_CLEAR_ALL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CLEAR_ALL, purgeReasonFlag4TestUint32)
	}

}

func TestUint32OnMiss(t *testing.T) {
	fun := func(k uint32) (Cacheable, bool) {
		return 1, true
	}
	cache := NewLRUCacheUint32(1)
	cache.OnMiss(fun)
