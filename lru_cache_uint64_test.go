...
func TestUInt64InitialState(t *testing.T) {
	cache := NewLRUCacheUint64(5)
	l, sz, c := cache.Stats()
	if l != 0 {
...
func TestUInt64SetInsertsValue(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	data := &CacheValue{0}
	var k uint64 = 1
	cache.Set(k, data)
...
func TestUInt64SetIfAbsent(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	data := &CacheValue{0}
	var k uint64 = 1
...
func TestUInt64GetValueWithMultipleTypes(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	data := &CacheValue{0}
	var k uint64 = 1
	cache.Set(k, data)
...
func TestUInt64SetUpdatesSize(t *testing.T) {
	cache := NewLRUCacheUint64(100)
...
func TestUInt64SetWithOldKeyUpdatesValue(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	emptyValue := &CacheValue{0}
	k := uint64(1)
	cache.Set(k, emptyValue)
...
func TestUInt64SetWithOldKeyUpdatesSize(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	emptyValue := &CacheValue{0}
	k := uint64(1)
	cache.Set(k, emptyValue)
...
func TestUInt64GetNonExistent(t *testing.T) {
	cache := NewLRUCacheUint64(100)
...
func TestUInt64CapacityIsObeyed(t *testing.T) {
	size := int64(3)
	cache := NewLRUCacheUint64(100)
...
func TestUInt64LRUIsEvicted(t *testing.T) {
	size := int64(3)
	cache := NewLRUCacheUint64(size)
...
type PurgeCacheValueUInt64 struct {
}

func (cv *PurgeCacheValueUInt64) OnPurge(why PurgeReason) {
	purgeReasonFlag4TestUInt64 = why
}

var purgeReasonFlag4TestUInt64 PurgeReason

func TestUInt64DeleteOnPurge(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	value := &PurgeCacheValueUInt64{}
	purgeReasonFlag4TestUInt64 = PURGE_REASON_CACHEFULL // init
	var k uint64 = 1

	cache.Set(k, value)
	cache.Delete(k)
	if purgeReasonFlag4TestUInt64 != PURGE_REASON_DELETE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_DELETE, purgeReasonFlag4TestUInt64)
	}

}

func TestUInt64UpdateOnPurge(t *testing.T) {
	cache := NewLRUCacheUint64(100)
	value := &PurgeCacheValueUInt64{}
	purgeReasonFlag4TestUInt64 = PURGE_REASON_CACHEFULL // init
	var k uint64 = 1
	...
	if purgeReasonFlag4TestUInt64 != PURGE_REASON_UPDATE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_UPDATE, purgeReasonFlag4TestUInt64)
	}

}

func TestUInt64CacheFullOnPurge(t *testing.T) {
	cache := NewLRUCacheUint64(1)
	value := &PurgeCacheValueUInt64{}
	k1 := uint64(1)
	k2 := uint64(2)

	cache.Set(k1, value)                             // after this cache is full
	purgeReasonFlag4TestUInt64 = PURGE_REASON_DELETE // init
	cache.Set(k2, value)                             // after this k1 is delete and reason set to  PURGE_REASON_CACHEFULL
	if purgeReasonFlag4TestUInt64 != PURGE_REASON_CACHEFULL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CACHEFULL, purgeReasonFlag4TestUInt64)
	}

}

func TestUInt64ClearOnPurge(t *testing.T) {
	cache := NewLRUCacheUint64(1)
	value := &PurgeCacheValueUInt64{}
	k1 := uint64(1)
	purgeReasonFlag4TestUInt64 = PURGE_REASON_DELETE // init
	cache.Set(k1, value)                             // after this cache is full
	cache.Clear()
	if purgeReasonFlag4TestUInt64 != PURGE_REASON_CLEAR_ALL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CLEAR_ALL, purgeReasonFlag4TestUInt64)
	}

}

func TestUInt64OnMiss(t *testing.T) {
	fun := func(k uint64) (Cacheable, bool) {
		return 1, true
	}
	cache := NewLRUCacheUint64(1)
	cache.OnMiss(fun)
