...
func TestKeyInt32InitialState(t *testing.T) {
	cache := NewLRUCacheKeyInt32(5)
	l, sz, c := cache.Stats()
	if l != 0 {
...
func TestKeyInt32SetInsertsValue(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	data := &CacheValue{0}
	var k key.KeyInt32 = 1
	cache.Set(k, data)
...
func TestKeyInt32SetIfAbsent(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	data := &CacheValue{0}
	var k key.KeyInt32 = 1
...
func TestKeyInt32GetValueWithMultipleTypes(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	data := &CacheValue{0}
	var k key.KeyInt32 = 1
	cache.Set(k, data)
...
func TestKeyInt32SetUpdatesSize(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
...
func TestKeyInt32SetWithOldKeyUpdatesValue(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	emptyValue := &CacheValue{0}
	k := key.KeyInt32(1)
	cache.Set(k, emptyValue)
...
func TestKeyInt32SetWithOldKeyUpdatesSize(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	emptyValue := &CacheValue{0}
	k := key.KeyInt32(1)
	cache.Set(k, emptyValue)
...
func TestKeyInt32GetNonExistent(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
...
func TestKeyInt32Delete(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	value := &CacheValue{1}
	var k key.KeyInt32 = 1
...
func TestKeyInt32Clear(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	value := &CacheValue{1}
	var k key.KeyInt32 = 1
...
func TestKeyInt32CapacityIsObeyed(t *testing.T) {
	size := int64(3)
	cache := NewLRUCacheKeyInt32(100)
...
func TestKeyInt32LRUIsEvicted(t *testing.T) {
	size := int64(3)
	cache := NewLRUCacheKeyInt32(size)
...
type PurgeCacheValueKeyInt32 struct {
}

func (cv *PurgeCacheValueKeyInt32) OnPurge(why PurgeReason) {
	purgeReasonFlag4TestKeyInt32 = why
}

var purgeReasonFlag4TestKeyInt32 PurgeReason

func TestKeyInt32DeleteOnPurge(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	value := &PurgeCacheValueKeyInt32{}
	purgeReasonFlag4TestKeyInt32 = PURGE_REASON_CACHEFULL // init
	var k key.KeyInt32 = 1

	cache.Set(k, value)
	cache.Delete(k)
	if purgeReasonFlag4TestKeyInt32 != PURGE_REASON_DELETE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_DELETE, purgeReasonFlag4TestKeyInt32)
	}

}

func TestKeyInt32UpdateOnPurge(t *testing.T) {
	cache := NewLRUCacheKeyInt32(100)
	value := &PurgeCacheValueKeyInt32{}
	purgeReasonFlag4TestKeyInt32 = PURGE_REASON_CACHEFULL // init
	var k key.KeyInt32 = 1
	...
	if purgeReasonFlag4TestKeyInt32 != PURGE_REASON_UPDATE {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_UPDATE, purgeReasonFlag4TestKeyInt32)
	}

}

func TestKeyInt32CacheFullOnPurge(t *testing.T) {
	cache := NewLRUCacheKeyInt32(1)
	value := &PurgeCacheValueKeyInt32{}
	k1 := key.KeyInt32(1)
	k2 := key.KeyInt32(2)

	cache.Set(k1, value)                               // after this cache is full
	purgeReasonFlag4TestKeyInt32 = PURGE_REASON_DELETE // init
	cache.Set(k2, value)                               // after this k1 is delete and reason set to  PURGE_REASON_CACHEFULL
	if purgeReasonFlag4TestKeyInt32 != PURGE_REASON_CACHEFULL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CACHEFULL, purgeReasonFlag4TestKeyInt32)
	}

}

func TestKeyInt32ClearOnPurge(t *testing.T) {
	cache := NewLRUCacheKeyInt32(1)
	value := &PurgeCacheValueKeyInt32{}
	k1 := key.KeyInt32(1)
	purgeReasonFlag4TestKeyInt32 = PURGE_REASON_DELETE // init
	cache.Set(k1, value)                               // after this cache is full
	cache.Clear()
	if purgeReasonFlag4TestKeyInt32 != PURGE_REASON_CLEAR_ALL {
		t.Errorf("after cache.Delete ,purgeReason should be %d ,but get %d", PURGE_REASON_CLEAR_ALL, purgeReasonFlag4TestKeyInt32)
	}

}

func TestKeyInt32OnMiss(t *testing.T) {
	fun := func(k key.KeyInt32) (Cacheable, bool) {
		return 1, true
	}
	cache := NewLRUCacheKeyInt32(1)
	cache.OnMiss(fun)
